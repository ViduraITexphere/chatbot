...
const ProjectCard = ({ id, title, model }) => {
  ...
  const handleOpen = () => {
    ...
    setIframeCode(
      ...
      `<iframe id="chatbot-iframe" src="https://chatbot-nu-six.vercel.app/?objectId=${id}" width="380px" height="480px" frameborder="0" style="position: fixed; bottom: 20px; left: 0; z-index: 999;"></iframe>`
    );
  };
